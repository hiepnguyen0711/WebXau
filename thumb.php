...
if(! defined('FILE_CACHE_SUFFIX') )             define ('FILE_CACHE_SUFFIX', '.timthumb.cache');                  // What to put at the end of all files in the cache directory so we can identify them
...
class timthumb {
        ...
        protected function error($err){
                header('Location: http://localhost/nghinhi/');
